...
/* FDM: read FDM parameters */
    ...
    ret += sscanf(line, "EOSCriticalDensity2 = %"FSYM, &EOSCriticalDensity2);
    ret += sscanf(line, "EOSCriticalDensity3 = %"FSYM, &EOSCriticalDensity3);
    ret += sscanf(line, "EOSGamma = %"FSYM, &EOSGamma);
    ret += sscanf(line, "EOSGamma2 = %"FSYM, &EOSGamma2);
    ret += sscanf(line, "EOSGamma3 = %"FSYM, &EOSGamma3);
